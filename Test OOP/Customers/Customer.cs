...
namespace Test_OOP
{
    public class Customer
    {
        ...
        public void OutToText()
        {
            ...
            sw.WriteLine("\t\t\tMã khách hàng: " + _idCustomer);
            sw.WriteLine("\t\t\tTên khách hàng: " + _nameCustomer);
